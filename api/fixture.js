...
export default async function handler(req, res) {
  ...
  try {
    ...
    return res.status(200).json({ jogo, eventos, escalacoes, lineupsStatus, h2h, emFalta, estatisticas, momentum, posicoesMedias, _debugStatsKeys: statsResp ? Object.keys(statsResp) : null, _debugAvgPosRaw: statsResp?.average_positions || null });
